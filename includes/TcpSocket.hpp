...
public:
	...
	std::string read_request_body_unchunked(int max_body_size); // Read the body of the request
	std::string read_request_body_chunked(int max_body_size);	// Read the body of the request with chunked encoding
